...
date: 2021-06-11
excerpt: "Alteryx Chief Data and Analytics Officer Alan Jacobson talks about leading data scientists who create tools to be used by other data scientists. Alan Jacobson, Chief Data and Analytics Officer at Alteryx, joined us on the Data Science Mixer podcast…"
original_url: "https://towardsdatascience.com/principal-components-alan-jacobson-on-building-data-science-tools-16cae3681aff"
---

*Originally published at [https://towardsdatascience.com/principal-components-alan-jacobson-on-building-data-science-tools-16cae3681aff](https://towardsdatascience.com/principal-components-alan-jacobson-on-building-data-science-tools-16cae3681aff)*
...
![](https://miro.medium.com/max/10000/0*ChZ-Av7Ib_CZzAq2)
...
> *Take the jargon out and use examples that we can all picture in our everyday lives.*

Data science, in general, is really not that hard. Certainly, there are concepts in data science that are harder than others. But the majority of what a practicing data scientist does — it’s not thermodynamics. Thermodynamics was a very hard course. At least for me, that was a really hard course. Multidimensional calculus. That’s a pretty abstract, hard-to-picture kind of thing.

I find that most data science principles are things that you can explain in pretty plain terms. I have two kids. They’re a middle schooler and a high schooler, and they can understand these concepts. Frequently, when I’m training these concepts, I’m trying to take the jargon out and trying to use examples that we can all picture in our everyday lives.

I really do feel passionately that data science is an area that eventually should be part of what everyone does. It’s not just for the Ph.D. data scientist to do data science. It’s math. It’s for everybody. Not to say that there won’t be deep-end-of-the-pool, complex things that you need a data scientist for, but I’d really love to see everybody in their day-to-day work be able to leverage this stuff.

*These interview responses have been lightly edited for length and clarity.*

*The podcast show notes and a full transcript are available on the* [*Alteryx Community*](https://community.alteryx.com/t5/Data-Science-Mixer/Building-data-science-tools-for-data-scientists-Alan-Jacobson/ba-p/764385?utm_source=tds)*.*