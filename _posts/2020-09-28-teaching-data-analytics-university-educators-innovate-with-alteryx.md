...
Ng has also created two graduate courses, including one called Advanced Data Analytics and Innovation in Accounting that he will teach for the first time next year. The course will also include topics like data transformation using Alteryx, [robotic process automation (RPA) with UiPath](https://www.alteryx.com/press-releases/2020-08-12-alteryx-and-uipath-partner-to-accelerate-digital-transformation-with?UTM_Content=community), and artificial intelligence software for audit applications.
...
Ng is also fortunate to have a collaborative, enthusiastic alumnus in [Cameron O’Donnell](https://www.linkedin.com/in/cameron-odonnell/), now a senior associate in Tax Transformation & Technology at KPMG. O’Donnell has guest lectured in Ng's classes, including a session on using Alteryx to load and prepare data for analysis.
...
Ng has parlayed his teaching innovations into journal articles and a book. He has published articles on the use and teaching of [RPA](https://mydigitalpublication.com/publication/?i=652870&ver=html5&p=18), [AI and machine learning](https://mydigitalpublication.com/publication/?i=583202&ver=html5&p=5), [blockchain](https://mydigitalpublication.com/publication/?i=572243&ver=html5&p=16) and [data visualization](https://mydigitalpublication.com/publication/?i=523119&ver=html5&p=24) in accounting, and has a new co-authored book coming out next year, [*Artificial Intelligence in Accounting: Practical Applications*](https://www.routledge.com/Artificial-Intelligence-in-Accounting-Practical-Applications/Ng-Alarcon/p/book/9780367431778).
...
“Facebook is extremely limited in what you can do demographically and wants to pigeonhole you into using their mysterious analytics ... as opposed to you having control over, ‘Who am I targeting? Who's responding?’” Pechmann says. She has published [about this issue](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7305557/) as well.
...
At the end of the course, Sarkar’s students compete in a game called [ERPsim](https://erpsim.hec.ca/). “They form teams where they would compete against each other as if they're running organizations, everything from forecasting to production to sales. They compete against each other to see who has the most income,” Sarkar explains. For a final twist, he extracts the data from the game and has the students use Tableau to present their outcomes.
...
* We’ve also got [a lively discussion](https://community.alteryx.com/t5/General-AFG-Discussions/Educators-How-Have-You-Integrated-Alteryx-Into-Your-Curriculum/td-p/593663) going about integrating Alteryx into your curriculum. Read, learn, ask questions, contribute!

We hope you’ll join this important conversation about teaching data skills!

*Blog title image from [#WOCinTech](https://www.flickr.com/photos/wocintechchat/) on Flickr.*