---
title: "Fighting Disease with Data: Q&A with Epidemiologist Amrish Baidjoe"
date: 2020-06-01
excerpt: "SAS Viya
Data science tools are powerful for investigating the current pandemic and other outbreaks, when accurate and actionable data are crucial. But they become even more powerful combined with complementary, varied domain expertise and tools for…"
...
As I researched data science topics related to the COVID-19 pandemic, I ran across the article [“Outbreak Analytics: A Developing Data Science for Informing the Response to Emerging Pathogens”](https://royalsocietypublishing.org/doi/full/10.1098/rstb.2018.0276?url_ver=Z39.88-2003&rfr_id=ori%3Arid%3Acrossref.org&rfr_dat=cr_pub%3Dpubmed&). I was fascinated by the article’s approach to using data analytics to cope with disease outbreaks. I reached out to one of its authors, [Amrish Baidjoe](https://twitter.com/Ammer_B), honorary assistant professor at the London School of Hygiene and Tropical Medicine and president of the European Alumni Association for Field Epidemiology. Baidjoe also was vice-president of the [R Epidemics Consortium](https://www.repidemicsconsortium.org/) (RECON), a group that developed R tools and training for use in epidemics.
...
When it comes to the utility I see in these types of tools, what’s really important is reproducibility and transparency on how the analysis was performed. The open-source nature allows for a lot of people to develop all kinds of analytical packages. So they're much more powerful beyond the traditional analytical packages. For example, with the inclusion of geospatial data, you can use R to make maps. With more software having open APIs, you can more easily connect to other data sources. There is an increase in data that has been made publicly: for example, on [Humanitarian Data Exchange](https://data.humdata.org/), or data that has been crowdsourced in projects such as the [Humanitarian OpenStreetMap project](https://www.hotosm.org/), which provides important GIS data and population estimates for analyses. There is also [healthsites](https://healthsites.io/), which provides data on locations of health facilities and their capabilities.
...
[Original](https://community.alteryx.com/t5/Data-Science-Blog/Fighting-Disease-with-Data-Q-amp-A-with-Epidemiologist-Amrish/ba-p/577203). Reposted with permission.

[<= **Previous post**](https://www.kdnuggets.com/2020/06/top-tweets-jun03-09.html)

[**Next post** =>](https://www.kdnuggets.com/2020/06/manning-math-architectures-deep-learning.html)
