...
Photo by [Clem Onojeghuo](https://unsplash.com/@clemono?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/s/photos/steering-wheel-hands?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
...
Around the same time, Alteryx hosted [its first Twitter chat](https://twitter.com/hashtag/AlteryxChat), addressing topics like the democratization of data and upskilling for the data professions. Question 5 in the chat connected neatly with these issues around automation, the role of AI and how people and algorithms can work together:

There’s a lot to talk about here! Let’s cover the essentials ✅, go for a drive 🚗 and get a little philosophical 🤔.

# Less Tedium, More Creativity ✅

Everyone in the chat was rightly excited about the potential of automation to take over the dull bits of everyday work:
...
*Image from* [*the SAE*](https://www.sae.org/news/2019/01/sae-updates-j3016-automated-driving-graphic)
...
# How Humans May Change with AI Complements, or 😃 ➕ 🤖 = ❓
