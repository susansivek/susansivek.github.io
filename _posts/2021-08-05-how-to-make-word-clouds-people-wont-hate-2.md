...
date: 2021-08-05
excerpt: "Haters gonna hate on word clouds. But they’re still useful visualizations, and you can make them better.
Susan Currie Sivek, Ph.D.
4 hours ago·7 min read
Photo by on Unsplash
Word clouds: They sound so light, fluffy and fun. They’re a popular way of…"
original_url: "https://towardsdatascience.com/how-to-make-word-clouds-people-wont-hate-9a465c1b63ab"
---

*Originally published at [https://towardsdatascience.com/how-to-make-word-clouds-people-wont-hate-9a465c1b63ab](https://towardsdatascience.com/how-to-make-word-clouds-people-wont-hate-9a465c1b63ab)*

## Haters gonna hate on word clouds. But they’re still useful visualizations, and you can make them better.

[Susan Currie Sivek, Ph.D.](https://susansivek.medium.com/?source=post_page-----9a465c1b63ab--------------------------------)

[4 hours ago·7 min read](https://towardsdatascience.com/how-to-make-word-clouds-people-wont-hate-9a465c1b63ab?source=post_page-----9a465c1b63ab--------------------------------)

![](https://miro.medium.com/max/10000/1*dD33TqcwfP4mU72mJ407eA.jpeg)

*Photo by* *on* [*Unsplash*](https://unsplash.com/s/photos/cloud-heart-word?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
...
What’s these people’s problem with word clouds? They can indeed have issues when they aren’t used wisely, but there are ways to make them better. Let’s take a look at the critiques of word clouds and see how we can navigate around their potential pitfalls, especially when you’re using Alteryx Designer and the [Word Cloud Tool](https://help.alteryx.com/20212/designer/word-cloud) in the Text Mining palette of the Alteryx Intelligence Suite.

![](https://miro.medium.com/max/10000/0*b9SltOkIcnhPfnHl?q=20000000)

*Image via* [*GIPHY*](https://media.giphy.com/media/xlCGfjj0u5i7PzRKCd/giphy-downsized.gif)
...
![](https://miro.medium.com/max/10000/0*C6tVQOnvu_hy3Fhk?q=20000000)

*Image via* [*GIPHY*](https://media.giphy.com/media/xloX7WONvugBmUnGNb/giphy.gif)

There are strategies you can use to address each of these concerns for your word clouds. Let’s take a look at some of them. I’m going to use [a dataset](https://www.kaggle.com/nicapotato/womens-ecommerce-clothing-reviews) I previously used to [demonstrate sentiment analysis](https://community.alteryx.com/t5/Data-Science/Try-Sentiment-Analysis-with-Designer-You-Must/ba-p/589153); it contains reviews of clothing items.

First, we can deal with the issue of self-apparent and stop words fairly easily. In Alteryx Designer, be sure to set up a Text Pre-processing Tool before your Word Cloud Tool. Then, in the Word Cloud Tool, be sure to select the text field with \_processed after the original field name; I’ve forgotten to do this many times! In the pre-processing step, you can remove digits, punctuation, and stop words.
...
![](https://miro.medium.com/max/10000/0*Gk9rd_rCvRHCqvx9?q=20000000)
...
![](https://miro.medium.com/max/10000/0*9n8RK9EhnxH_392w?q=20000000)

*Image via* [*GIPHY*](https://media.giphy.com/media/PYsOfmCLHEaAg/giphy.gif)
...
![](https://miro.medium.com/max/10000/0*gyOR5UmqOSK_ej38?q=20000000)
...
![](https://miro.medium.com/max/10000/0*FBBG_KCc_1tAN9i0?q=20000000)

*Word clouds for negative reviews mentioning fabric, grouped by clothing type (from left to right: dresses, tops, and jackets; image by author)*
...
![](https://miro.medium.com/max/10000/0*keDVDsXUjhAg_Gfe?q=20000000)

*Image via* [*GIPHY*](https://media.giphy.com/media/26BGDQxDCZDFHW5Ne/giphy.gif)
...
![](https://miro.medium.com/max/10000/0*S3sIizqCOZqlALE4?q=20000000)

Image by author

Creating a bar chart like this from your text takes a few more steps, as you can see in the workflow attached to the [original version](https://community.alteryx.com/t5/Data-Science/How-to-Make-Word-Clouds-People-Won-t-Hate/ba-p/795468?utm_content=795468&utm_source=tds) of this article. The Text to Columns Tool set on “split to rows” makes it possible to convert the text reviews to individual lines; with a Summarize Tool and the Interactive Chart Tool, the bar chart comes together pretty quickly.
...
*Find the Alteryx workflow referenced in this article on the* [*Alteryx Data Science Blog*](https://community.alteryx.com/t5/Data-Science/How-to-Make-Word-Clouds-People-Won-t-Hate/ba-p/795468?utm_content=795468&utm_source=tds)*.*

* Read about some [word cloud alternatives](https://onlinejournalismblog.com/2018/02/05/text-as-data-journalism-sotu-speeches/#more-25542) for visualizing text data.
...
* [This tutorial](https://www.datacamp.com/community/tutorials/wordcloud-python) shows how to use Python to build word clouds, a method you could build into an Alteryx workflow with a Python Tool.
* For more on data visualization of all kinds, check out our Data Science Mixer podcast episodes with data viz expert and author Alberto Cairo; we have [a short episode](https://community.alteryx.com/t5/Data-Science-Mixer/Do-Charts-Lie-A-Conversation-with-Data-Visualization-Expert/ba-p/760177) and [a full-length episode](https://community.alteryx.com/t5/Data-Science-Mixer/Leveling-up-your-data-visualization-game-Alberto-Cairo/ba-p/779002) for your enjoyment!

*Originally published on the Alteryx Community* [*Data Science Blog*](https://community.alteryx.com/t5/Data-Science/How-to-Make-Word-Clouds-People-Won-t-Hate/ba-p/795468?utm_content=795468&utm_source=tds)*.*