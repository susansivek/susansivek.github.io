---
title: "Public Libraries Make Digital Magazines Accessible to All"
date: 2013-10-30
...
Magazine publishers are experimenting with all sorts of different ways to get you to pay for their digital products, including single issues, subscriptions, “buffets” (like [Next Issue](http://www.nextissue.com/)) and package deals (like Zinio’s [Z-Pass](http://us.zinio.com/www/browse/zpass.jsp)). But if you have a library card, you may be able to get quite a few digital magazines without paying anything at all.

Public libraries in cities large and small already offer their patrons digital magazines free of charge. The most common source is actually digital newsstand [Zinio](http://www.zinio.com/), which offers libraries subscriptions through the library services company [Recorded Books](http://www.recordedbooks.com/). Digital magazines are broadening libraries’ collections and deepening patrons’ interaction with library resources, helping them read media in the format they prefer, whenever and wherever.

## Serving Up Digital Magazines

The [Zinio service](http://www.recordedbooks.com/index.cfm?fuseaction=rb.zinio) offered by Recorded Books launched in October 2012 and now offers subscribing libraries a selection of 850 magazines from the U.S., U.K., Canada and Mexico, says Brad Gray, manager of business development at Recorded Books.
...
[![A look at the interface for library users of Zinio, from a screenshot of a Recorded Books instructional video.](https://i0.wp.com/mediashift.org/wp-content/uploads/2013/10/rb-zinio-screenshot.png?w=515)](https://i2.wp.com/mediashift.org/wp-content/uploads/sites/8/2013/10/rb-zinio-screenshot.png)
...
Two libraries that have adopted the Zinio/Recorded Books service — the [Los Angeles Public Library](http://www.lapl.org/) and the [Skokie (Ill.) Public Library](http://www.skokie.lib.il.us/) — are generally pleased with it so far, though they’ve encountered some challenges and found that not all patrons are ready to go digital.
...
[![Photo by Piscataway (N.J.) Public Library via their Tumblr.](https://i0.wp.com/mediashift.org/wp-content/uploads/2013/10/piscataway-library-sign.png?w=400)](https://i1.wp.com/mediashift.org/wp-content/uploads/sites/8/2013/10/piscataway-library-sign.png)
...
Another digital magazine service is just starting to experiment with a library service. [Foli](http://getfoli.com/) ([previously covered](http://mediashift.org/2013/06/location-matters-for-digital-magazines/) at MediaShift) is currently an iPad-only magazine app that detects a user’s GPS location and serves up digital magazines that have been purchased by the business — or library — at that location.
...
[![Escondido Public Library advertises its Foli service on its website.](https://i2.wp.com/mediashift.org/wp-content/uploads/2013/10/escondido-foli.png?w=372)](https://i1.wp.com/mediashift.org/wp-content/uploads/sites/8/2013/10/escondido-foli.png)

Escondido Public Library advertises its Foli service on its website.

So far, patrons’ response to Foli has lagged, says Viktor Sjöberg, digital services librarian for the . Part of the problem may be the iPad-only nature of Foli, which is working on an Android version of its app.
