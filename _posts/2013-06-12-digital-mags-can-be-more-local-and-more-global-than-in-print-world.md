...
The magazine newsstand at Blue Scorcher Cafe & Bakery in Astoria, Ore., could take digital form with a new app.
...
## Foli: Magazines, Hyperlocal

[![A map of some of Foli's locations in the Bay Area.](https://i2.wp.com/mediashift.org/wp-content/uploads/2013/05/foli-map.jpg?w=515)](https://i2.wp.com/mediashift.org/wp-content/uploads/sites/8/2013/05/foli-map.jpg)

[A map of some of Foli's locations in the Bay Area.](http://www.getfoli.com/index.html)

It’s one of the biggest cliches about reading magazines in public: that outdated, dull selection of magazines at the doctor’s office. Startup Foli wants to kill that cliche and reinvent the public magazine reading experience. co-founder and CEO Henry He saw the growth of tablet devices as an opportunity.
...
Foli, currently available only as an [iPad app](https://itunes.apple.com/ua/app/foli/id495505469?mt=8), enables visitors at participating businesses to open the app, view a custom newsstand, and read digital magazines selected by the business. These might be consumer magazines (largely PDF-style replicas), but businesses can also include their own publications.

[![Foli's newsstand in trial mode, which allows for an hour of free reading anywhere.](https://i0.wp.com/mediashift.org/wp-content/uploads/2013/05/foli-newsstand.jpg?w=515)](https://i2.wp.com/mediashift.org/wp-content/uploads/sites/8/2013/05/foli-newsstand.jpg)

For example, He said, a hotel could include its restaurant and bar menus, as well as its own magazine (as did the [Four Seasons Silicon Valley](http://siliconvalley.enewsletters.fourseasons.com/2013/03/02/high-tech-high-touch-foli-app/)). Content can be updated daily to display the business’s news and events, and can be customized for the business’s typical customers. Other businesses using Foli include coffee shops, hair salons and spas.
...
## Magzter: Magazines, Global

[![Magzter's iPad newsstand.](https://i2.wp.com/mediashift.org/wp-content/uploads/2013/05/magzter-newsstand.jpg?w=515)](https://i1.wp.com/mediashift.org/wp-content/uploads/sites/8/2013/05/magzter-newsstand.jpg)

[Magzter's iPad newsstand.](http://www.magzter.com/)

Magzter’s iPad newsstand.

While location is everything for Foli users, location is increasingly irrelevant because of apps such as . Magzter, available for multiple platforms, offers 1,700 magazine titles to 8.5 million users, according to Vijay Radhakrishnan, co-founder and president of Magzter. He said these users are distributed widely, with 2 million in the U.S., 2 million in the U.K., 3 million from Asia and 1.5 million from the rest of the world.

Magzter’s biggest recent coup was announced in April: a [deal with Hearst](http://www.foliomag.com/2013/hearst-signs-digital-newsstand-magzter) to offer Hearst magazines, including all of its U.S. editions and a selection of its international publications, through its service. Magzter takes a 50 percent revenue cut from publishers’ sales, significantly more than Apple’s 30 percent, but also can collect and share more valuable [reader data](http://pandodaily.com/2013/04/09/magzter-is-a-digital-magazines-giant-that-has-come-from-nowhere-well-okay-asia-to-sign-hearst-and-newsweek/) with publishers than Apple does. Magzter offers mostly digital replicas through its service, though some magazines include interactive features.
...
[![The Indian edition of Harper's Bazaar is available through Magzter, along with many other international magazines.](https://i0.wp.com/mediashift.org/wp-content/uploads/2013/05/magzter-bazaar.jpg?w=515)](https://i2.wp.com/mediashift.org/wp-content/uploads/sites/8/2013/05/magzter-bazaar.jpg)
...
1. Considering many magazines are now maintaining a web presence, and how creative apps like Magzter are popping up, the digital realm is definitely opening publications up to a wider potential audience. With that said, it is interesting to consider what effect this will have on the type of content magazines will feature as their reading population grows to a more diverse status. In many ways even widely recognized magazines like Good Housekeeping tailor their stories, media, and advertisements to a specific group of people (namely, American women, or more specifically, U.S. mothers/housewives). I suppose with the technology available today it isn’t hard to create digital ads that vary depending on the viewer (clearly search engines like Google and Bing perform this action already). However, making sure the main features of a magazine appeal to a very broad spectrum of people (all with varying backgrounds, ages, geographic locations, cultures, and so on), would be a more challenging task.

   To use the example of Good Housekeeping again, the magazine clearly spotlights popular North American styles and ideals; things which can be seen as out of the norm, irrelevant, or strange for European or South American readers. My guess is that while many magazines will continue to appeal to their original niche audiences, those that take advantage of the expanded market for viewership might actually fragment their publications. This would lead to more off-shoot publications like Good Housekeeping London, Good Housekeeping Paris, Good Housekeeping Rio, etc. Or, perhaps more simply, this could mean the expansion of perspectives expressed (in order to appeal to a greater audience), with the thoughtful categorization of digital material for easy location.