...
![](https://miro.medium.com/max/10000/0*DIS5ma1JOp0MGk7T?q=20000000)

*Image via* [*GIPHY*](https://giphy.com/gifs/love-heart-valentines-l3q2zWh6nXHl3x8gU)

If you’re a fan of the Data Investigation tool palette, you might wonder how Data Health differs from the [Field Summary Tool](https://help.alteryx.com/current/designer/field-summary-tool). You do get some of the same information from both tools; however, it’s important to note that Data Health provides “an overall measure of the goodness of your dataset,” as Alteryx data science product manager [Sonia Prakasam](https://www.linkedin.com/in/sonia-prakasam-2718239a/) recently told me. “Data Health generates results that are more actionable. It’s great to use before any machine learning process to help get data ready for a machine learning pipeline.”
...
![](https://miro.medium.com/max/10000/0*BtHlT-dqMauCyD4s?q=20000000)

*Image by* [*Schlurcher*](https://commons.wikimedia.org/wiki/User:Schlurcher)*, Wikimedia Commons*
...
![](https://miro.medium.com/max/10000/0*o-zwvCTCJb2KALnB?q=20000000)

*Image via* [*GIPHY*](https://giphy.com/gifs/doctorwho-doctor-who-dr-jodie-whittaker-fX1VB1UZiEKok6TiLm)
...
![](https://miro.medium.com/max/10000/1*l2Fb9G8owvtt9ylXu_jrqw.png?q=20000000)
...
![](https://miro.medium.com/max/10000/1*mE6mgrf2XkBnsQ54kuu2cQ.png?q=20000000)
