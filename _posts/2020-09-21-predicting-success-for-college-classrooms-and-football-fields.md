...
For more inspiration on how to use predictive analytics, watch the video below from Educause, where some institutional leaders explain the role of predictive analytics at their institutions. You can also check out this [free e-book](https://www.alteryx.com/e-book/data-innovators-in-higher-ed?UTM_Content=community) from Alteryx that showcases seven different schools’ use of analytics in different areas of their institutions.

Finally, [join our higher ed discussions](https://community.alteryx.com/t5/forums/filteredbylabelpage/board-id/industry-discussions/label-name/higher%20education) to share how you’re using data in higher education!