...
Food magazines pride themselves on delectable recipes and luscious photography. [Recipe.com](http://www.recipe.com/), whose title is also its website’s URL, is a new publication from magazine giant [Meredith](http://www.meredith.com/), and while every recipe is indeed accompanied by a photo, the print magazine’s content is thoughtfully integrated with digital tools targeted to cost-conscious home cooks.
...
![i-501dcc5d8b898cf99ddde2dd4e00ba93-Recipe.com Fall Cover.jpg](http://mediashift.org/wp-content/uploads/sites/8/import/i-501dcc5d8b898cf99ddde2dd4e00ba93-Recipe.com%20Fall%20Cover.jpg)
...
![i-62f4bc6a089cb6c523056953bf79a7ba-recipe-sale.jpg](https://i2.wp.com/mediashift.org/wp-content/uploads/sites/8/import/i-62f4bc6a089cb6c523056953bf79a7ba-recipe-sale.jpg)

The state of the economy was a major consideration for the Recipe.com team. Research in-house at Meredith and [elsewhere](http://www.valassis.com/1024/resources/GMcouponUse.aspx) shows that as consumers have become more price-aware, they are planning meals more diligently, shopping less often, and using coupons more frequently.
...
Recipe.com, in all of its forms, was designed to provide tools to these budget-conscious shoppers. The recipes in the magazine, drawn from Meredith’s many magazines, are each accompanied by their approximate cost per serving. Most recipes also have a [Microsoft Tag](http://tag.microsoft.com/what-is-tag/home.aspx) 2D barcode that readers can scan with a smartphone app to add ingredient lists to a Recipe.com shopping list. The list is then available on the web or through Recipe.com’s own [shopping list mobile app](http://www.recipe.com/shopping-list-app/).

The shopping list app also syncs with any list items a user has saved on the website. (Both fully featured and mobile versions are available.) More grocery items can be added through barcode scanning or voice recognition. The list itself is then matched to specials at nearby grocery stores, automatically identified via GPS, through the [Grocery Server](https://www.groceryserver.com/groceryserver/gs/) shopping engine. The user can select preferred stores from those suggested, refine the list with the deals offered, and go shopping.
...
![i-dce162fe8c0f2ff086d7f07a002cdf6f-shopping-list.jpg](https://i0.wp.com/mediashift.org/wp-content/uploads/sites/8/import/i-dce162fe8c0f2ff086d7f07a002cdf6f-shopping-list.jpg)
